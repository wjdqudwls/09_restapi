package com.wjdqudwls.restapi.section01.response;
...
// 모든 핸들러 메서드가 데이터만 응답을 하는 컨트롤러
@RequestMapping("/response")
public class ResponseController {

  /* 1. 문자열 응답 */
  @GetMapping("/hello")
  //@ResponseBody // View Resolver를 찾아가지 않고,
  // 응답 body에 담겨 그대로 클라이언트에게 응답
  ...
  public byte[] getImage() throws IOException {
    ...
    return getClass()
        .getResourceAsStream("/images/study.jpeg")
        .readAllBytes();
  }
  /* 6. ResponseEntity 응답 */
  @GetMapping("/entity")
