package com.wjdqudwls.cqrs.product.command.application.service;

import com.wjdqudwls.cqrs.common.service.FileStorageService;
...
import com.wjdqudwls.cqrs.product.command.domain.aggregate.ProductStatus;
...
public class ProductCommandService {
  ...
  /* 상품 수정 */
  @Transactional
  public void updateProduct(Long productCode,
                            ProductUpdateRequest productUpdateRequest,
                            MultipartFile productImg) {
    // JPA 를 이용한 DB 수정 방법
    // 1) 수정할 데이터를 조회 -> 조회된 Entity(영속상태)
