package com.wjdqudwls.cqrs.product.query.service;

import com.wjdqudwls.cqrs.common.dto.Pagination;
import com.wjdqudwls.cqrs.exception.BusinessException;
import com.wjdqudwls.cqrs.exception.ErrorCode;
import com.wjdqudwls.cqrs.product.query.dto.request.ProductSearchRequest;
import com.wjdqudwls.cqrs.product.query.dto.response.ProductDTO;
...
import com.wjdqudwls.cqrs.product.query.mapper.ProductMapper;
...
@Service
@RequiredArgsConstructor // final이 붙은 필드를 초기화 하는 생성자 어노테이션
public class ProductQueryService {
  ...
  public ProductDetailResponse getProduct(Long productCode) {
    ...
    /* Mybatis는 매퍼를 통해서 조회 결과를 바로 DTO에 매핑 할 수 있음
     * -> JPA 보다 편함(Query Side 장점) */
    /* Optional : null 일 경우와 아닐 경우에 대한 동작을 선택하는 null 처리 객체 */

    // 조회결과 있으면 ProductDTO 반환
    // 조회 결과가 없을 경우 예외 발생
  ...
  public ProductListResponse getProducts(
    ...
    List<ProductDTO> products
        = productMapper.selectProducts(productSearchRequest);
