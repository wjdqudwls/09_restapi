...
import com.ohgiraffers.springsecurity.command.dto.TokenResponse;
...
public class AuthService {
  ...
  public TokenResponse login(LoginRequest request) {
    ...
    String accessToken = jwtTokenProvider.createToken(user.getUsername(), user.getRole().name()); //  String accessToken = ""; 토큰 발급 과정떄문에 아직 빈칸
