...
public class CustomUserDetailsService implements UserDetailsService { //구현하는거니 implements

  private final UserRepository userRepository; //UserRepository == 커멘드
  ...
  public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
    ...
    return new org.springframework.security.core.userdetails.User( // 조회된걸로 userdetails에게 담아둠
        user.getUsername(),
        user.getPassword(),
