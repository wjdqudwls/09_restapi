package com.mycompany.cqrs.product.command.domain.aggreagete;
...
@NoArgsConstructor(access = AccessLevel.PROTECTED) // JPA만 기본 생성자 사용가능하게 설정. (JPA가 Proxy 객체 만들때 상속해서 만드므로)
@Getter
@EntityListeners(AuditingEntityListener.class) // 엔티티 삽입, 수정 감지 시, 시간을 기록
...
public class Product {
  ...
  /* product 상태를 저장할 enum 타입을 DB에 저장할 때, 문자열로 저장 */
