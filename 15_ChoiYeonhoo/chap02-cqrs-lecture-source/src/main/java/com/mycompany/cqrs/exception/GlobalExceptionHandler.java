package com.mycompany.cqrs.exception;
...
//    return new ResponseEntity<>(response, errorCode.getHttpStatus());
  ...
  /* @Validated 유효성 검사 실패 시 예외 처리*/
  @ExceptionHandler(MethodArgumentNotValidException.class)
  public ResponseEntity<ApiResponse<Void>> handledValidationException(MethodArgumentNotValidException e){
