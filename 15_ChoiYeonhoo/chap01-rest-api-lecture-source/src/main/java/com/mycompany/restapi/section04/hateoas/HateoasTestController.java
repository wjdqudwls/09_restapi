...
import com.mycompany.restapi.section02.responseentity.ResponseMessage;
...
* - 클라이언트가 하드 코딩된 URL 없이도 API를 탐색할 수 있다.
*   (API 진화에 유연하게 대응할 수 있다).
*
* - REST API 성숙도 모델 (0~3 레벨) 중 3레벨을 달성하기 위한 기술
* LV 0 : REST 원칙을 거의 지키지 않음
* LV 1 : 자원 개념만 도입
* LV 2 : HTTP Method 활용(GET, POST, PUT, DELETE) + HTTP 상태코드
* LV 3 : 응답 본문에 다음 수행할 수 있는 작업 링크를 포함
* */
