package com.mycompany.springsecurirty.jwt;
...
public class JwtTokenProvider {
  ...
  public String createToken(String username, String role){
    ...
    return Jwts.builder()
        .subject(username) // payload: subject (보통 사용자 식별값) (등록 Claim)
        ...
        .signWith(secretKey)    // signature: 비밀 키 서명 (위변조 반지)
        .compact();
  }
  ...
  /* JWT 토큰중 payload -> claim --> subject의 값(username) 반환 */
